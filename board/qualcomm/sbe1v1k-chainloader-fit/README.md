...
At startup the helper prints the served FIT path, size, and SHA256. Check that
hash against the generated `sbe1v1k-chainloader.itb` before booting from stock
U-Boot.
