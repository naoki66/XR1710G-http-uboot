...
enum qti_8x8x_adc_edge_t {
	ADC_RISING = 0,
	ADC_FALLING = 0xf0,
};

enum port_header_mode_t {
	FAL_NO_HEADER_EN = 0,
...
struct qti_8x8x_parent_data {
	...
	enum qti_8x8x_clk_parent_t parent;	/* RCG parent clock id */
...
struct mac_config_t {
	enum qti_8x8x_mac_mode_t mac_mode;
	enum qti_8x8x_clock_mode_t clock_mode;
	bool auto_neg;
	u32 speed;
	bool prbs_enable;
	bool rem_phy_lpbk;
