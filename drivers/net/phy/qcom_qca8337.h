...
#define S17_AUTONEG_DONE(ip_phy_status) \
	(((ip_phy_status) & S17_STATUS_AUTO_NEG_DONE) == \
...
#define S17_DEBUG_SERDES_REG                5

/* Serdes debug fields */
#define S17_SERDES_BEACON                   0x0100
...
#define S17_MIB_COUNTER_ENABLE		BIT(0)
#define S17_MIB_NON_CLEAR		BIT(20)
...
#define S17_MASK_CTRL_SOFT_RET		BIT(31)

#define S17_GLOBAL_INT0_ACL_INI_INT        BIT(29)
#define S17_GLOBAL_INT0_LOOKUP_INI_INT     BIT(28)
#define S17_GLOBAL_INT0_QM_INI_INT         BIT(27)
#define S17_GLOBAL_INT0_MIB_INI_INT        BIT(26)
#define S17_GLOBAL_INT0_OFFLOAD_INI_INT    BIT(25)
#define S17_GLOBAL_INT0_HARDWARE_INI_DONE  BIT(24)
...
#define S17_MAC0_MAC_MII_RXCLK_SEL      BIT(0)
#define S17_MAC0_MAC_MII_TXCLK_SEL      BIT(1)
#define S17_MAC0_MAC_MII_EN             BIT(2)
#define S17_MAC0_MAC_GMII_RXCLK_SEL     BIT(4)
#define S17_MAC0_MAC_GMII_TXCLK_SEL     BIT(5)
#define S17_MAC0_MAC_GMII_EN            BIT(6)
#define S17_MAC0_SGMII_EN               BIT(7)
#define S17_MAC0_PHY_MII_RXCLK_SEL      BIT(8)
#define S17_MAC0_PHY_MII_TXCLK_SEL      BIT(9)
#define S17_MAC0_PHY_MII_EN             BIT(10)
#define S17_MAC0_PHY_MII_PIPE_SEL       BIT(11)
#define S17_MAC0_PHY_GMII_RXCLK_SEL     BIT(12)
#define S17_MAC0_PHY_GMII_TXCLK_SEL     BIT(13)
#define S17_MAC0_PHY_GMII_EN            BIT(14)
#define S17_MAC0_RGMII_RXCLK_SHIFT      20
#define S17_MAC0_RGMII_TXCLK_SHIFT      22
#define S17_MAC0_RGMII_RXCLK_DELAY      BIT(24)
#define S17_MAC0_RGMII_TXCLK_DELAY      BIT(25)
#define S17_MAC0_RGMII_EN               BIT(26)

#define S17_MAC5_MAC_MII_RXCLK_SEL      BIT(0)
#define S17_MAC5_MAC_MII_TXCLK_SEL      BIT(1)
#define S17_MAC5_MAC_MII_EN             BIT(2)
#define S17_MAC5_PHY_MII_RXCLK_SEL      BIT(8)
#define S17_MAC5_PHY_MII_TXCLK_SEL      BIT(9)
#define S17_MAC5_PHY_MII_EN             BIT(10)
#define S17_MAC5_PHY_MII_PIPE_SEL       BIT(11)
#define S17_MAC5_RGMII_RXCLK_SHIFT      20
#define S17_MAC5_RGMII_TXCLK_SHIFT      22
#define S17_MAC5_RGMII_RXCLK_DELAY      BIT(24)
#define S17_MAC5_RGMII_TXCLK_DELAY      BIT(25)
#define S17_MAC5_RGMII_EN               BIT(26)

#define S17_MAC6_MAC_MII_RXCLK_SEL      BIT(0)
#define S17_MAC6_MAC_MII_TXCLK_SEL      BIT(1)
#define S17_MAC6_MAC_MII_EN             BIT(2)
#define S17_MAC6_MAC_GMII_RXCLK_SEL     BIT(4)
#define S17_MAC6_MAC_GMII_TXCLK_SEL     BIT(5)
#define S17_MAC6_MAC_GMII_EN            BIT(6)
#define S17_MAC6_SGMII_EN               BIT(7)
#define S17_MAC6_PHY_MII_RXCLK_SEL      BIT(8)
#define S17_MAC6_PHY_MII_TXCLK_SEL      BIT(9)
#define S17_MAC6_PHY_MII_EN             BIT(10)
#define S17_MAC6_PHY_MII_PIPE_SEL       BIT(11)
#define S17_MAC6_PHY_GMII_RXCLK_SEL     BIT(12)
#define S17_MAC6_PHY_GMII_TXCLK_SEL     BIT(13)
#define S17_MAC6_PHY_GMII_EN            BIT(14)
#define S17_PHY4_GMII_EN                BIT(16)
#define S17_PHY4_RGMII_EN               BIT(17)
#define S17_PHY4_MII_EN                 BIT(18)
#define S17_MAC6_RGMII_RXCLK_SHIFT      20
#define S17_MAC6_RGMII_TXCLK_SHIFT      22
#define S17_MAC6_RGMII_RXCLK_DELAY      BIT(24)
#define S17_MAC6_RGMII_TXCLK_DELAY      BIT(25)
#define S17_MAC6_RGMII_EN               BIT(26)

#define S17_SPEED_10M                   (0 << 0)
#define S17_SPEED_100M                  (1 << 0)
#define S17_SPEED_1000M                 (2 << 0)
#define S17_TXMAC_EN                    BIT(2)
#define S17_RXMAC_EN                    BIT(3)
#define S17_TX_FLOW_EN                  BIT(4)
#define S17_RX_FLOW_EN                  BIT(5)
#define S17_DUPLEX_FULL                 BIT(6)
#define S17_DUPLEX_HALF                 (0 << 6)
#define S17_TX_HALF_FLOW_EN             BIT(7)
#define S17_LINK_EN                     BIT(9)
#define S17_FLOW_LINK_EN                BIT(12)
...
#define S17_HDRLENGTH_SEL               BIT(16)
...
#define S17_CPU_PORT_EN                 BIT(10)
#define S17_PPPOE_REDIR_EN              BIT(8)
#define S17_MIRROR_PORT_SHIFT           4
#define S17_IGMP_COPY_EN                BIT(3)
#define S17_RIP_COPY_EN                 BIT(2)
#define S17_EAPOL_REDIR_EN              BIT(0)
...
#define S17_PWS_CHIP_AR8327		BIT(30)
#define S17c_PWS_SERDES_ANEG_DISABLE	BIT(7)

/* For EEE_CTRL_REG */
#define S17_LPI_DISABLE_P1              BIT(4)
#define S17_LPI_DISABLE_P2              BIT(6)
#define S17_LPI_DISABLE_P3              BIT(8)
#define S17_LPI_DISABLE_P4              BIT(10)
#define S17_LPI_DISABLE_P5              BIT(12)
#define S17_LPI_DISABLE_ALL             0x1550

/* For MMD register control */
#define S17_MMD_FUNC_ADDR               (0 << 14)
#define S17_MMD_FUNC_DATA               BIT(14)
#define S17_MMD_FUNC_DATA_2             (2 << 14)
#define S17_MMD_FUNC_DATA_3             (3 << 14)

/* For phyInfo_t azFeature */
#define S17_8023AZ_PHY_ENABLED                  BIT(0)
#define S17_8023AZ_PHY_LINKED                   BIT(1)
...
#define S17_MODULE_L3_EN                     BIT(2)
#define S17_MODULE_ACL_EN                    BIT(1)
#define S17_MODULE_MIB_EN                    BIT(0)

/* MIB Function Register 1 */
#define S17_MIB_FUNC_ALL                     (3 << 24)
#define S17_MIB_CPU_KEEP                     BIT(20)
#define S17_MIB_BUSY                         BIT(17)
#define S17_MIB_AT_HALF_EN                   BIT(16)
#define S17_MIB_TIMER_DEFAULT                0x100

#define S17_MAC_MAX                          7

/* MAC power selector bit definitions */
#define S17_RGMII0_1_8V                       BIT(19)
#define S17_RGMII1_1_8V                       BIT(18)

/* SGMII_CTRL bit definitions */
#define S17c_SGMII_EN_LCKDT		      BIT(0)
#define S17c_SGMII_EN_PLL		      BIT(1)
#define S17c_SGMII_EN_RX		      BIT(2)
#define S17c_SGMII_EN_TX		      BIT(3)
#define S17c_SGMII_EN_SD		      BIT(4)
#define S17c_SGMII_BW_HIGH		      BIT(6)
#define S17c_SGMII_SEL_CLK125M		      BIT(7)
#define S17c_SGMII_TXDR_CTRL_600MV	      BIT(10)
#define S17c_SGMII_CDR_BW_8		      (3 << 13)
#define S17c_SGMII_DIS_AUTO_LPI_25M	      BIT(16)
#define S17c_SGMII_MODE_CTRL_SGMII_PHY	      BIT(22)
#define S17c_SGMII_PAUSE_SG_TX_EN_25M	      BIT(24)
#define S17c_SGMII_ASYM_PAUSE_25M	      BIT(25)
#define S17c_SGMII_PAUSE_25M		      BIT(26)
#define S17c_SGMII_HALF_DUPLEX_25M	      BIT(30)
#define S17c_SGMII_FULL_DUPLEX_25M	      BIT(31)

/* No need to redefine BOOL, use bool from stdbool.h or kernel headers */
...
#define SPEED_1000M				BIT(3)
#define SPEED_100M				BIT(2)
