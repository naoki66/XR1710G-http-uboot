...
/*
 * U-Boot currently drives the IPQ9574 NSSCC reset controller through the
 * legacy GCC binding IDs above. Keep Linux binding names available for DTS
 * compatibility while preserving the existing provider numbering.
 */
#define PORT1_TX_ARES						NSS_CC_PORT1_TX_RESET
#define PORT1_RX_ARES						NSS_CC_PORT1_RX_RESET
#define PORT2_TX_ARES						NSS_CC_PORT2_TX_RESET
#define PORT2_RX_ARES						NSS_CC_PORT2_RX_RESET
#define PORT3_TX_ARES						NSS_CC_PORT3_TX_RESET
#define PORT3_RX_ARES						NSS_CC_PORT3_RX_RESET
#define PORT4_TX_ARES						NSS_CC_PORT4_TX_RESET
#define PORT4_RX_ARES						NSS_CC_PORT4_RX_RESET
#define PORT5_TX_ARES						NSS_CC_PORT5_TX_RESET
#define PORT5_RX_ARES						NSS_CC_PORT5_RX_RESET
#define PORT6_TX_ARES						NSS_CC_PORT6_TX_RESET
#define PORT6_RX_ARES						NSS_CC_PORT6_RX_RESET
#define PORT1_MAC_ARES						NSS_CC_PORT1_MAC_RESET
#define PORT2_MAC_ARES						NSS_CC_PORT2_MAC_RESET
#define PORT3_MAC_ARES						NSS_CC_PORT3_MAC_RESET
#define PORT4_MAC_ARES						NSS_CC_PORT4_MAC_RESET
#define PORT5_MAC_ARES						NSS_CC_PORT5_MAC_RESET
#define PORT6_MAC_ARES						NSS_CC_PORT6_MAC_RESET
#define PPE_FULL_RESET						NSS_CC_PPE_CFG_RESET
